...
typedef enum {
	SCD4x_SENSOR_SCD40 = 0, SCD4x_SENSOR_SCD41
} scd4x_sensor_type_e;
...
public:
	...
	bool begin(uint8_t i2c_address = 0, I2C_HandleTypeDef *i2c_handle = NULL,
			 bool measBegin = true, bool autoCalibrate = true, bool skipStopPeriodicMeasurements = false); //By default use Wire port
...
//	void enableDebugging(Stream &debugPort = Serial); //Turn on debug printing. If user doesn't specify then Serial will be used
	...
	bool stopPeriodicMeasurement(uint16_t delayMillis = 500, I2C_HandleTypeDef *i2c_handle = NULL);
